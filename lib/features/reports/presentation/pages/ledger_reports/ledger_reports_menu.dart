...
class LedgerReportsMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      ('🥇', 'Top Customers by Revenue', 'Customers ranked by total spend',
          const TopCustomersReportPage()),
      ('🧾', 'Customer Purchase History', 'Select customer and view all bills',
          const CustomerPurchaseHistorySelectorPage()),
      ('📌', 'Pending Dues & Credit', 'Outstanding credit customers and statements',
          const PendingDuesReportPage()),

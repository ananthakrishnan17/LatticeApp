...
import 'cash_in_hand_report_page.dart';
import 'cashier_sessions_dashboard_page.dart';
...
import 'payment_method_wise_report_page.dart';
...
class FinancialReportsMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      ('💳', 'Payment Method Wise', 'Collections by payment mode', const PaymentMethodWiseReportPage()),
      ('💵', 'Cash In Hand', 'Expected drawer cash by cashier', const CashInHandReportPage()),
      ('🧾', 'Cashier Sessions Dashboard', 'Admin EOD all cashier sessions', const CashierSessionsDashboardPage()),

...
class _ExpandableBillCardState extends State<_ExpandableBillCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final isModified = ((b['is_modified'] as num?)?.toInt() ?? 0) == 1;
    final modificationNote = (b['modification_note'] as String?)?.trim();
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        if (_expanded && isModified && modificationNote != null && modificationNote.isNotEmpty)
          Padding(
            padding: EdgeInsets.fromLTRB(14.w, 0, 14.w, 12.h),
            child: Align(

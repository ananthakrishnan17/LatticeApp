...
class CartItemTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final baseTotal = item.baseTotalFor(billType);
    final discountAmount = item.itemDiscountAmountFor(billType);
          ...
          Expanded(
            child: Column(
              ...
              children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      Container(
                        ...
                        child: Text(
                          item.itemDiscountType == ItemDiscountType.percent
                              ? '${item.itemDiscountValue.toStringAsFixed(item.itemDiscountValue % 1 == 0 ? 0 : 1)}% off'
                              : '${CurrencyFormatter.format(item.itemDiscountValue)} off',
                ...
                if (item.hasItemDiscount)
                  Text(
                    'Row total from ${CurrencyFormatter.format(baseTotal)}',
                    style: AppTheme.caption,
                  ),
              ],
            ),

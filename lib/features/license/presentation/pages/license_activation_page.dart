  ...
  Widget _infoCard(LicenseType type) {
    ...
    final points = isOnline
        ? [
            ...
            '☁️ Transactions are sent directly to backend APIs',
            '🚫 No local sync queue is used',
            '🔒 Recommended when always-online usage is expected',
          ]
        : [
            '✅ Works both online and offline after login',
            '💾 All data stored locally',
            '📂 Google Drive backup available',
            '🔒 Backend is used for login & license validation only',
          ];

...
class SalesLoaded extends SalesState {
  ...
  final Map<String, double> todaySettlementByMode;
  ...
  SalesLoaded({
    ...
    required this.todaySettlementByMode,
  });
...
class SalesBloc extends Bloc<SalesEvent, SalesState> {
  ...
  Future<void> _onLoadSalesData(LoadSalesData event, Emitter<SalesState> emit) async {
    ...
    try {
      ...
      final todaySettlementByMode =
          await _repository.getTodaySettlementByPaymentMode(today);
      ...
      emit(SalesLoaded(
        ...
        todaySettlementByMode: todaySettlementByMode,
      ));
    } catch (e) {
